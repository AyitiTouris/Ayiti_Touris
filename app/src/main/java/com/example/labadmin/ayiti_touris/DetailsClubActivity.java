...
public class DetailsClubActivity extends AppCompatActivity {
     ...
     * @param club    Identificador de la chica
     * @return Intent user list
     */
    public static Intent getLaunchIntent(Context context, Club club) {
        Intent intent = new Intent(context, DetailsClubActivity.class);
        intent.putExtra(EXTRA_NAME, club.getName());
        intent.putExtra(EXTRA_DRAWABLE, club.getIdDrawable());
        return intent;
    }
