...
public class Restaurants {
    public static final String[] RestaurantDiner = {
            ...
            "Les Jardins du Mupanah","Harry's","Kokoye Bar & Grill","Hotel NH Haiti El Rancho","Yanvalou","Portofino","Tiffany's","The View","Smokey's Bar & Grill",
            ...
            "Pizza Garden","Smookey's Bar and Grill","Jojo Restaurant","Cafe Albert","Redstone","L'Observatoire des Boutiliers","The View", "L'Estaminet", "Le Vieux Tunnel", "Rond Point", "Obi", "Midi Express", "Lunch Break", "La Sirene - Marriot", "La Brasserie",
            "Kanel - Plaza Hotel", "Ananas Restaurant"
    };
