...
public class DetailsPlageActivity extends AppCompatActivity {
    ...
    private static final String LOG_TXT = "DetailsPlageActivity";
     ...
     */
    public static Intent getLaunchIntent(Context context, Plage hotel) {
    ...
    void callMap()
    {
        Intent i = new Intent(DetailsPlageActivity.this, MapsActivity.class);
        startActivity(i);
