...
/**
 * Created by domin on 06-Sep-17.
 */

public class AdapterFavorite extends ArrayAdapter<Endroit> {
    // View lookup cache
    RatingBar ratingBar;
    ...
    public AdapterFavorite(Context context, ArrayList<Endroit> users) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AdapterFavorite.ViewHolder viewHolder; // view lookup cache stored in tag
        if (convertView == null) {
            // If there's no view to re-use, inflate a brand new view for row
            viewHolder = new AdapterFavorite.ViewHolder();
            ...
            viewHolder = (AdapterFavorite.ViewHolder) convertView.getTag();
        }
